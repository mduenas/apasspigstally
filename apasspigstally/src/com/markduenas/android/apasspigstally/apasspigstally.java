...
public class apasspigstally extends Activity implements View.OnClickListener {
	...
	public void onClick(View view) {
		...
		setUIValues(tally1);
		if(tally1.isPigout() == true) toastMsg("Pigout!!!", 3000);
	}
	/**
    ...
    /**
     * setButtonListener sets all the buttons on the form
     * to listen via the same handler
     * @param l
     * @param id
     */
