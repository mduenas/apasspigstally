...
public class PigsDB extends SQLiteOpenHelper
{
	...
	private static final String CREATE_TABLE_MAIN = "CREATE TABLE IF NOT EXISTS " + DB_TABLE_MAIN + "(apasspigs_id integer primary key autoincrement, " + "piggyName text not null, piggyScore integer null);";

	public PigsDB(Context ctx)
	{
	...
	public List<Row> fetchAllRows()
	{
		...
		try
		{
			...
			Cursor c = db.query(CREATE_TABLE_MAIN, new String[] { "apasspigs_id", "piggyName", "piggyScore" }, null, null, null, null, null);
	...
	public Cursor GetAllRows()
	{
		...
		try
		{
			return db.query(CREATE_TABLE_MAIN, new String[] { "apasspigs_id", "piggyName", "piggyScore" }, null, null, null, null, null);
		}
		catch (SQLException e)
		{
	...
	public long piggyExists(String piggyName)
	{
		...
		try
		{
			c = db.query(CREATE_TABLE_MAIN, new String[] { "apasspigs_id", "piggyName", "piggyScore" }, "piggyName='" + piggyName + "'", null, null, null, null);
			int numRows = c.getCount();
			if (numRows > 0)
			{
				c.moveToFirst();
